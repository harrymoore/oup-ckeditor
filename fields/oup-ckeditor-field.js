     ...
     */
    {
      toolbarOptions: {
        config1: {
          toolbar: [
            ...
            ["Link", "Unlink", "Anchor", "cloudcms-link"],
        ...
        config2: {
          toolbar: [["SpecialChar", "Italic", "Subscript", "Superscript"]]
        },
        config3: {
          toolbar: [
            ["Cut", "Copy", "Paste", "-", "Undo", "Redo"],
            ["Link", "Unlink", "cloudcms-link"],
            [
              "Bold",
              "Italic",
              "Strike",
        ...
        config4: {
          toolbar: [["Link", "Unlink", "cloudcms-link"]],
          "cloudcms-link": {
            linkPickerType: "file-picker",
            linkPickerConfig: {
              initialContainerPath: "/"
      ...
      setup: function() {
        if (
          ...
          this.toolbarOptions[this.options.ckeditor]
        ) {
